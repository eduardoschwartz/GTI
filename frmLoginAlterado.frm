...
'Public Sub GetMenuInfo(hMenu As Long, spaces As Integer, txt As String)
Dim Num As Integer
Dim i As Integer
Dim length As Long
...
'frmMdi.m_cMenuRelatorio.Enabled(nIndex) = True
frmMdi.mnuCertidoes.Enabled = True
