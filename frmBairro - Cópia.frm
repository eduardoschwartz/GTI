...
If NomeDeLogin <> "FACTORE" And NomeDeLogin <> "SCHWARTZ" And NomeDeLogin <> "MARIELA" Then
...
If cmbCidade.ItemData(cmbCidade.ListIndex) = 413 And NomeDeLogin <> "FACTORE" And NomeDeLogin <> "SCHWARTZ" And NomeDeLogin <> "MARIELA" Then
...
If sUF <> "" Then
    If sFormCall = "frmCadImob" Then
        ...
        For x = 0 To frmCadImob.cmbBairro.ListCount
            ...
            End If
        Next
    ElseIf sFormCall = "frmCidadao" Then
