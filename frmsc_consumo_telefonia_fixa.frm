...
Begin VB.Form frmsc_consumo_telefonia_fixa 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consumo de Telefonia Fixa"
   ClientHeight    =   4755
   ClientLeft      =   16770
   ClientTop       =   2610
   ClientWidth     =   6780
   ...
   Begin VB.Frame Frame2 
      ...
      Begin esMaskEdit.esMaskedEdit mskVencto 
         ...
         _ExtentX        =   2408
         _ExtentY        =   503
         MouseIcon       =   "frmsc_consumo_telefonia_fixa.frx":0000
      ...
      Begin prjChameleon.chameleonButton cmdNovo 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_telefonia_fixa.frx":001C
         PICN            =   "frmsc_consumo_telefonia_fixa.frx":0038
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdExcluir 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_telefonia_fixa.frx":0192
         PICN            =   "frmsc_consumo_telefonia_fixa.frx":01AE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdAlterar 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_telefonia_fixa.frx":0250
         PICN            =   "frmsc_consumo_telefonia_fixa.frx":026C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdGravar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmsc_consumo_telefonia_fixa.frx":03C6
         PICN            =   "frmsc_consumo_telefonia_fixa.frx":03E2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdCancel 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_telefonia_fixa.frx":0787
         PICN            =   "frmsc_consumo_telefonia_fixa.frx":07A3
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmsc_consumo_telefonia_fixa"
...
If MsgBox("Deseja excluir este período?", vbQuestion + vbYesNo + vbDefaultButton2, "Confirmação") = vbYes Then
    Sql = "delete from sc_ligacao_telefonia_fixa_consumo where codigo=" & nCodigo & " and ano=" & nAno & " and mes=" & nMes
...
If Evento = "ALTERAR" Then
    Sql = "update sc_ligacao_telefonia_fixa_consumo set consumo=" & Val(txtConsumo.Text) & ",dias=" & Val(txtDias.Text) & ",empenho=" & sNull(txtEmpenho.Text) & ","
    ...
    cn.Execute Sql, rdExecDirect
Else
    Sql = "select * from sc_ligacao_telefonia_fixa_consumo where codigo=" & nCodigo & " and ano=" & Val(cmbAno.Text) & " and mes=" & nMes
    ...
    Sql = "insert sc_ligacao_telefonia_fixa_consumo(codigo,ano,mes,consumo,valor,dias,datavencimento,empenho) values(" & Val(lblCod.Caption) & ","
...
Me.Top = frmsc_telefonia_fixa.Top + 1000
Me.Left = frmsc_telefonia_fixa.Left + 2000
Header
LoadPeriodo
...
Limpa
GridHeader
lblCod.Caption = frmsc_telefonia_fixa.lblCod.Caption
lblLigacao.Caption = frmsc_telefonia_fixa.txtFone.Text
txtUnidade.Text = frmsc_telefonia_fixa.txtNome.Text
...
Sql = "SELECT * from sc_ligacao_telefonia_fixa_consumo Where codigo = " & nCodigo & " AND ano = " & nAno & " AND mes = " & nMes
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    If .RowCount > 0 Then
...
grdMain.Clear
Sql = "SELECT codigo,ano,mes,consumo FROM sc_ligacao_telefonia_fixa_consumo WHERE codigo=" & nCodigo & " ORDER BY ano DESC, mes desc"
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
        If !ano > nAno Then
...
cmbMesAno.Clear
Sql = "SELECT DISTINCT mes, ano FROM sc_ligacao_telefonia_fixa_consumo WHERE codigo=" & Val(lblCod.Caption) & " ORDER BY ano DESC, mes desc"
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
