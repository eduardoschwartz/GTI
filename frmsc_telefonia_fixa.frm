...
Begin VB.Form frmsc_telefonia_fixa 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Controle das Unidades - Telefonia Fixa"
   ClientHeight    =   6840
   ClientLeft      =   11310
   ClientTop       =   3915
   ClientWidth     =   11010
   LinkTopic       =   "frmsc_unidade_telefonie_fixa"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   6840
   ScaleWidth      =   11010
   Begin prjChameleon.chameleonButton cmdConsumo 
      ...
      MCOL            =   16777152
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":0000
      PICN            =   "frmsc_telefonia_fixa.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdNovo 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":03BA
      PICN            =   "frmsc_telefonia_fixa.frx":03D6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdAlterar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":0530
      PICN            =   "frmsc_telefonia_fixa.frx":054C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdSair 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":06A6
      PICN            =   "frmsc_telefonia_fixa.frx":06C2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdGravar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":0730
      PICN            =   "frmsc_telefonia_fixa.frx":074C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdCancel 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":0AF1
      PICN            =   "frmsc_telefonia_fixa.frx":0B0D
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin prjChameleon.chameleonButton cmdFiltrar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmsc_telefonia_fixa.frx":0C67
         PICN            =   "frmsc_telefonia_fixa.frx":0C83
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdExcluir 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_fixa.frx":0E5D
      PICN            =   "frmsc_telefonia_fixa.frx":0E79
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmsc_telefonia_fixa"
...
If Evento = "ALTERAR" Then
    nCodigo = Val(lblCod.Caption)
    Sql = "update sc_telefonia_fixa set secretaria=" & nSec & ",dotacao=" & sNullVal(txtDotacao.Text) & ",nome=" & sNull(txtNome.Text) & ","
...
Else
    Sql = "select max(codigo) as maximo from sc_telefonia_fixa"
    ...
    Sql = "insert sc_telefonia_fixa(codigo,secretaria, telefone,nome,endereco,dotacao) values(" & nCodigo & "," & nSec & "," & sNull(txtFone.Text) & ","
...
Sql = "SELECT sc_telefonia_fixa.codigo,sc_telefonia_fixa.nome,sc_telefonia_fixa.endereco,sc_telefonia_fixa.dotacao,sc_telefonia_fixa.telefone,sc_secretaria.sigla,sc_secretaria.codigo AS codigo_secretaria "
Sql = Sql & "FROM sc_telefonia_fixa INNER JOIN sc_secretaria ON sc_telefonia_fixa.secretaria = sc_secretaria.codigo"
If Filter <> "" Then
    Sql = Sql & " where sc_telefonia_fixa.nome like '%" & Mask(Filter) & "%' or endereco like '%" & Mask(Filter) & "%' or telefone like '%" & Mask(Filter) & "%' or sigla like '%" & Mask(Filter) & "%'"
End If
Sql = Sql & " ORDER BY sc_telefonia_fixa.nome "
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
        grdMain.AddRow
...
Else
    If MsgBox("Você deseja excluir esta unidade e todo o seu consumo?", vbQuestion + vbYesNo + vbDefaultButton2, "Confirmação") = vbYes Then
        Sql = "delete from sc_telefonia_fixa where codigo=" & nCodigo
        cn.Execute Sql, rdExecDirect
        Sql = "delete from sc_ligacao_telefonia_fixa_consumo where codigo=" & nCodigo
        cn.Execute Sql, rdExecDirect
        Limpa
