...
Begin VB.Form frmsc_consumo_internet 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consumo de Internet"
   ClientHeight    =   4740
   ClientLeft      =   8235
   ClientTop       =   4470
   ClientWidth     =   6795
   ...
   Begin VB.Frame Frame2 
      ...
      Begin esMaskEdit.esMaskedEdit mskVencto 
         ...
         _ExtentX        =   2408
         _ExtentY        =   503
         MouseIcon       =   "frmsc_consumo_internet.frx":0000
      ...
      Begin prjChameleon.chameleonButton cmdNovo 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_internet.frx":001C
         PICN            =   "frmsc_consumo_internet.frx":0038
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdExcluir 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_internet.frx":0192
         PICN            =   "frmsc_consumo_internet.frx":01AE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdAlterar 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_internet.frx":0250
         PICN            =   "frmsc_consumo_internet.frx":026C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdGravar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmsc_consumo_internet.frx":03C6
         PICN            =   "frmsc_consumo_internet.frx":03E2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin prjChameleon.chameleonButton cmdCancel 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmsc_consumo_internet.frx":0787
         PICN            =   "frmsc_consumo_internet.frx":07A3
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmsc_consumo_internet"
...
If MsgBox("Deseja excluir este período?", vbQuestion + vbYesNo + vbDefaultButton2, "Confirmação") = vbYes Then
    Sql = "delete from sc_ligacao_internet_consumo where codigo=" & nCodigo & " and ano=" & nAno & " and mes=" & nMes
...
If Evento = "ALTERAR" Then
    Sql = "update sc_ligacao_internet_consumo set consumo=" & Val(txtConsumo.Text) & ",dias=" & Val(txtDias.Text) & ",empenho=" & sNull(txtEmpenho.Text) & ","
    ...
    cn.Execute Sql, rdExecDirect
Else
    Sql = "select * from sc_ligacao_internet_consumo where codigo=" & nCodigo & " and ano=" & Val(cmbAno.Text) & " and mes=" & nMes
    ...
    Sql = "insert sc_ligacao_internet_consumo(codigo,ano,mes,consumo,valor,dias,datavencimento,empenho) values(" & Val(lblCod.Caption) & ","
...
Me.Top = frmsc_conexao_internet.Top + 1000
Me.Left = frmsc_conexao_internet.Left + 2000
Header
LoadPeriodo
...
Private Sub Header()
Dim x As Integer, sFone As String, sNumero As String
sFone = frmsc_conexao_internet.txtFone.Text
sNumero = frmsc_conexao_internet.txtLigacao.Text

Limpa
GridHeader
lblCod.Caption = frmsc_conexao_internet.lblCod.Caption
lblLigacao.Caption = IIf(sFone = "", sNumero, sFone)
txtUnidade.Text = frmsc_conexao_internet.txtNome.Text
...
Sql = "SELECT * from sc_ligacao_internet_consumo Where codigo = " & nCodigo & " AND ano = " & nAno & " AND mes = " & nMes
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    If .RowCount > 0 Then
...
grdMain.Clear
Sql = "SELECT codigo,ano,mes,consumo FROM sc_ligacao_internet_consumo WHERE codigo=" & nCodigo & " ORDER BY ano DESC, mes desc"
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
        If !ano > nAno Then
...
cmbMesAno.Clear
Sql = "SELECT DISTINCT mes, ano FROM sc_ligacao_internet_consumo WHERE codigo=" & Val(lblCod.Caption) & " ORDER BY ano DESC, mes desc"
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
