...
'Private Declare Function CallWindowProc Lib "user32" Alias "CallWindowProcA" (ByVal lpPrevWndFunc As Long, ByVal hwnd As Long, ByVal msgWinMessage As Long, ByVal wParam As Long, lParam As Any) As Long
'Private Declare Sub CopyMemory Lib "kernel32" Alias "RtlMoveMemory" (Dest As Any, Source As Any, ByVal nLen As Long)
...
Private Function HHSubclassWndProc(ByVal hwnd As Long, ByVal msgWinMessage As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
