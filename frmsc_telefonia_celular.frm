...
Begin VB.Form frmsc_telefonia_celular 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Controle das Unidades - Telefonia Celular"
   ClientHeight    =   6825
   ClientLeft      =   4755
   ClientTop       =   5400
   ClientWidth     =   11010
   ...
   Begin VB.Frame Frame1 
      ...
      Begin prjChameleon.chameleonButton cmdFiltrar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmsc_telefonia_celular.frx":0000
         PICN            =   "frmsc_telefonia_celular.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdNovo 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":01F6
      PICN            =   "frmsc_telefonia_celular.frx":0212
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdExcluir 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":036C
      PICN            =   "frmsc_telefonia_celular.frx":0388
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdAlterar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":042A
      PICN            =   "frmsc_telefonia_celular.frx":0446
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdConsumo 
      ...
      MCOL            =   16777152
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":05A0
      PICN            =   "frmsc_telefonia_celular.frx":05BC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdSair 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":095A
      PICN            =   "frmsc_telefonia_celular.frx":0976
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdGravar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":09E4
      PICN            =   "frmsc_telefonia_celular.frx":0A00
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdCancel 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmsc_telefonia_celular.frx":0DA5
      PICN            =   "frmsc_telefonia_celular.frx":0DC1
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmsc_telefonia_celular"
...
If Trim(txtFone.Text) = "" Then
    MsgBox "Digite o nº do telefone", vbCritical, "Erro"
    Exit Sub
End If
...
If Evento = "ALTERAR" Then
    nCodigo = Val(lblCod.Caption)
    Sql = "update sc_telefonia_celular set secretaria=" & nSec & ",dotacao=" & sNullVal(txtDotacao.Text) & ",nome=" & sNull(txtNome.Text) & ","
    Sql = Sql & "endereco=" & sNull(txtEndereco.Text) & ",telefone=" & sNull(txtFone.Text) & " where codigo=" & nCodigo
...
Else
    Sql = "select max(codigo) as maximo from sc_telefonia_celular"
    ...
    Sql = "insert sc_telefonia_celular(codigo,secretaria, telefone,nome,endereco,dotacao) values(" & nCodigo & "," & nSec & "," & sNull(txtFone.Text) & ","
...
With grdMain
    ...
    .AddColumn "kLig", "Telefone", ecgHdrTextALignLeft, , 90
...
Sql = "SELECT sc_telefonia_celular.codigo,sc_telefonia_celular.nome,sc_telefonia_celular.endereco,sc_telefonia_celular.dotacao,sc_telefonia_celular.telefone,sc_secretaria.sigla,sc_secretaria.codigo AS codigo_secretaria "
Sql = Sql & "FROM sc_telefonia_celular INNER JOIN sc_secretaria ON sc_telefonia_celular.secretaria = sc_secretaria.codigo"
If Filter <> "" Then
    Sql = Sql & " where sc_telefonia_celular.nome like '%" & Mask(Filter) & "%' or endereco like '%" & Mask(Filter) & "%' or telefone like '%" & Mask(Filter) & "%' or sigla like '%" & Mask(Filter) & "%'"
End If
Sql = Sql & " ORDER BY sc_telefonia_celular.nome "
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
        grdMain.AddRow
...
Else
    If MsgBox("Você deseja excluir esta unidade e todo o seu consumo?", vbQuestion + vbYesNo + vbDefaultButton2, "Confirmação") = vbYes Then
        Sql = "delete from sc_telefonia_celular where codigo=" & nCodigo
        cn.Execute Sql, rdExecDirect
        Sql = "delete from sc_ligacao_telefonia_celular_consumo where codigo=" & nCodigo
        cn.Execute Sql, rdExecDirect
        Limpa
