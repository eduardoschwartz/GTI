...
Begin VB.Form frmAssunto 
   ...
   ScaleHeight     =   5955
   ScaleWidth      =   9210
   Begin VB.ComboBox cmbValidade 
      Height          =   315
      ItemData        =   "frmAssunto.frx":0000
      Left            =   6480
      List            =   "frmAssunto.frx":000D
   ...
   Begin prjChameleon.chameleonButton cmdDR1 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":002B
      PICN            =   "frmAssunto.frx":0047
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdR2 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":00E6
      PICN            =   "frmAssunto.frx":0102
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdR1 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":025C
      PICN            =   "frmAssunto.frx":0278
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdCR1 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":03D2
      PICN            =   "frmAssunto.frx":03EE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdC2 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":048D
      PICN            =   "frmAssunto.frx":04A9
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdC1 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":0603
      PICN            =   "frmAssunto.frx":061F
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdRefresh 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":0779
      PICN            =   "frmAssunto.frx":0795
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdNovo 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":08EF
      PICN            =   "frmAssunto.frx":090B
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdAlterar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":0A65
      PICN            =   "frmAssunto.frx":0A81
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdExcluir 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":0BDB
      PICN            =   "frmAssunto.frx":0BF7
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdGravar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":0C99
      PICN            =   "frmAssunto.frx":0CB5
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdCancel 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":105A
      PICN            =   "frmAssunto.frx":1076
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdSair 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAssunto.frx":11D0
      PICN            =   "frmAssunto.frx":11EC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdPrint 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmAssunto.frx":125A
      PICN            =   "frmAssunto.frx":1276
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
lstAssunto_Click
cmbValidade.ListIndex = 0
End Sub

Private Sub CarregaLista()

lstCC1.Clear
Sql = "SELECT CODIGO,DESCRICAO,ATIVO FROM CENTROCUSTO WHERE ATIVO=1"
...
Sql = "SELECT * FROM ASSUNTO WHERE CODIGO=" & lstAssunto.ItemData(lstAssunto.ListIndex)
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
txtDesc.Text = RdoAux!Nome
If Not IsNull(RdoAux!VALIDADE_QTDE) Then
    txtValidade.Text = RdoAux!VALIDADE_QTDE
    cmbValidade.ListIndex = RdoAux!VALIDADE_TIPO - 1
Else
    txtValidade.Text = ""
    cmbValidade.ListIndex = 0
End If
...
Sql = "SELECT ASSUNTOCC.SEQ, ASSUNTOCC.CODCC, CENTROCUSTO.DESCRICAO "
Sql = Sql & "FROM ASSUNTOCC INNER JOIN CENTROCUSTO ON ASSUNTOCC.CODCC = CENTROCUSTO.CODIGO "
Sql = Sql & "Where CENTROCUSTO.Ativo = 1 And ASSUNTOCC.CODASSUNTO =" & lstAssunto.ItemData(lstAssunto.ListIndex)
Sql = Sql & " ORDER BY ASSUNTOCC.SEQ "
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
...
If lstAssunto.ListIndex = -1 Then Exit Sub
lstDoc2.Clear
Sql = "SELECT ASSUNTODOC.CODDOC,DOCUMENTO.NOME FROM ASSUNTODOC INNER JOIN "
Sql = Sql & "DOCUMENTO ON ASSUNTODOC.CODDOC = DOCUMENTO.CODIGO "
Sql = Sql & "Where ASSUNTODOC.CODASSUNTO = " & lstAssunto.ItemData(lstAssunto.ListIndex)
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
...
If Val(txtValidade.Text) = 0 Then
   txtValidade.Text = "0"
   cmbValidade.ListIndex = 0
End If
...
If sEvento = "Novo" Then
   ...
   Sql = "INSERT ASSUNTO (CODIGO,NOME,ATIVO,VALIDADE_TIPO,VALIDADE_QTDE) VALUES("
   Sql = Sql & nLastCod & ",'" & Mask(Left$(sDesc, 70)) & "',1," & cmbValidade.ListIndex + 1 & "," & Val(txtValidade.Text) & ")"
Else
   nLastCod = Val(txtCod.Text)
   Sql = "DELETE FROM ASSUNTOCC WHERE CODASSUNTO=" & nLastCod
   cn.Execute Sql, rdExecDirect
   Sql = "DELETE FROM ASSUNTODOC WHERE CODASSUNTO=" & nLastCod
   cn.Execute Sql, rdExecDirect
   Sql = "UPDATE ASSUNTO SET NOME='" & Mask(sDesc) & "',VALIDADE_TIPO=" & cmbValidade.ListIndex + 1 & ",VALIDADE_QTDE=" & Val(txtValidade.Text)
   Sql = Sql & "WHERE CODIGO=" & Val(txtCod.Text)
End If
cn.Execute Sql, rdExecDirect

For z = 1 To lvCC2.ListItems.Count
    Sql = "INSERT ASSUNTOCC (CODASSUNTO,SEQ,CODCC) VALUES("
...
For z = 0 To lstDoc2.ListCount - 1
    Sql = "INSERT ASSUNTODOC (CODASSUNTO,CODDOC) VALUES("
...
lstDoc2.Clear
lstAssunto.Clear
Sql = "SELECT CODIGO,NOME,ATIVO FROM ASSUNTO WHERE ATIVO=1 AND NOME LIKE '%" & Mask(txtAssunto.Text) & "%'"
Set RdoAux = cn.OpenResultset(Sql, rdOpenKeyset, rdConcurValues)
With RdoAux
    Do Until .EOF
...
Tweak txtValidade, KeyAscii, IntegerPositive
End Sub
